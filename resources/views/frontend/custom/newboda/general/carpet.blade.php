<div role="tabpanel" class="tab-pane fade active show endoflease" id="carpet">
    <div class="container" style="padding-bottom: 2em;">
        <div class="row">
            <div class="col-md-6 col-sm-12 px-md-1">
                <ul class="pricelist mb-1" style="margin-top: 1em;">
                    <li>First room   <div class="li-price"> <span>$70</span> </div></li>
                    <li class="bg-light">From the second room   <div class="li-price"> <span>$20</span>/room</div></li>
                </ul>
                <p>Our environmental-friendly chemicals and the latest technique can remove most common home stains, as well as most bacteria & allergens, leaving your property clean and fresh. </p>
            </div>
            <div class="col-md-6 col-sm-12">
                <p class="mb-1">Most property managers will ask tenants to do a profes­sional carpet steam clean before moving out.</p>
                <p>But a regular steam cleaning is also necessary in the <span class="color-normal">interests of hygiene</span>. Germs and mites are hiding it the depth of carpet, which cannot be cleaned by a vacuum cleaner. </p>
            </div>
        </div>
    </div>
    <div class="bg-light w-100 tab-down">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h3>DO YOU KNOW WE ALSO PROVIDE</h3>
                    <ul class="li-tick">
                        <li>Mattress steam clean</li>
                        <li>Coach steam clean </li>
