        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 px-md-1">
                ...
                <ul>
                    ...
                    <li><span class="color-normal">Regular clean: </span>on time every time, with reasonable price</li>
                    <li><span class="color-normal">Deep clean: </span>a thorough clean without breaking the bank</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <ul class="li-tick">
                        <li>After builders clean</li>
                        <li>After renovation clean </li>
                        <li>After party clean  </li>
                    </ul>

                    <h3 class="mt-1">SAME TEAM, EVERY TIME</h3>
                    <p>We will send the same group of cleaners to you once you booked a regular cleaning service, as they know better about your property, as well as your requirements.
                        Our cleaners will not leave until you are satisfied with their work - <span class="color-normal">we aim for perfection! </span></p>
                </div>
            </div>
        </div>
    </div>
